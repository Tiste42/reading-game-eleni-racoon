...
export const WORLDS: WorldConfig[] = [
  ...
  },
  {
    ...
    games: [
      { id: 'letter-intro', name: 'Meet the Letters', icon: '✨', description: 'Say hello to new letter friends!' },
      { id: 'sound-safari', name: 'Sound Safari', icon: '🦋', description: 'Find things that start with this letter!' },
      { id: 'letter-match', name: 'Letter Match', icon: '🎯', description: 'Match letters to their sounds!' },
      { id: 'sound-sort', name: 'Sound Sorting', icon: '🧺', description: 'Sort pictures by their first sound!' },
      { id: 'letter-trace', name: 'Letter Garden', icon: '🌱', description: 'Plant letters to grow words!' },
    ],
